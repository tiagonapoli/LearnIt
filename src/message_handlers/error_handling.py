...
def handle_user_dont_exist(bot, rtd, debug_mode):
	...
	def user_existence(msg):
		user_id = get_id(msg)
		error_msg = ("LearnIt is under development, so sometimes we have to do some experiments and reset some things, maybe because of this, your user isn't in our database. To fix this, please send a /start.")
